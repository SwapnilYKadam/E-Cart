...
const stripe = new Stripe("sk_test_51JYS4lSI7Mw1fgd2NC1u1zuN8MoDJmJxXiXThXuOPO2fMyYy4LrQmF1nqii7QuiGgAbvhSvfyXSiid5mDfw4N3o7000bisgEcI")

const getProductsFromCart = (cartitems) => {
    console.log('method', cartitems);
